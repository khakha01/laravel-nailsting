...
@section('title', 'Cập nhật Danh Mục Nail')
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-slate-900">Cập nhật Danh Mục Nail</h2>
                            <p class="text-xs text-slate-500 font-medium uppercase tracking-wider">ID:
                                #{{ $nailCategory->id }} -
                                Nail Category Management System</p>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if ($errors->any())
                <div class="mb-6 flex items-center p-4 text-red-800 border-t-4 border-red-500 bg-red-50 rounded-lg shadow-sm"
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium">Có lỗi xảy ra khi cập nhật:</h3>
            ...
            <form id="main-nail-category-form" action="{{ route('nail-categories.update', $nailCategory->id) }}"
                method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name', $nailCategory->name) }}"
                                        required placeholder="Nhập tên danh mục nail"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="slug" id="slug" value="{{ old('slug', $nailCategory->slug) }}"
                                        required placeholder="Nhập slug"
                            ...
                            <div class="p-4 rounded-xl border border-slate-100 bg-slate-50">
                                <div class="space-y-2 text-xs text-slate-600">
                                    <p class="flex justify-between">
                                        <span>Ngày tạo:</span>
                                        <span
                                            class="font-medium">{{ $nailCategory->created_at->format('d/m/Y H:i') }}</span>
                                    </p>
                                    <p class="flex justify-between">
                                        <span>Cập nhật cuối:</span>
                                        <span
                                            class="font-medium">{{ $nailCategory->updated_at->format('d/m/Y H:i') }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
