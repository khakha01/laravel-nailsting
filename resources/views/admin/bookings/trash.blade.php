...
@section('title', 'Thùng rác đặt lịch')
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-10 bg-gray-50 h-full min-h-screen">
        ...
        <div class="md:flex md:items-center md:justify-between mb-8">
            <div class="min-w-0 flex-1">
                ...
                <p class="mt-1 text-sm text-gray-500">Các yêu cầu đặt lịch đã bị xóa.</p>
            </div>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        {{-- Force Delete Button --}}
                                        <form method="POST" action="{{ route('bookings.force-delete', $booking->id) }}"
                                            class="inline-block"
