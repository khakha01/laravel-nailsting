...
@section('content')
    ...
    <form id="bulk-restore-form" action="{{ route('nail-bookings.bulk-restore') }}" method="POST" class="hidden">
        @csrf
    </form>
    <form id="bulk-force-delete-form" action="{{ route('nail-bookings.bulk-force-delete') }}" method="POST" class="hidden">
        @csrf
        @method('DELETE')
    </form>
