...
@section('title', 'Quản lý đặt lịch Nail')
...
@section('content')
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-10 bg-gray-50 h-full min-h-screen">
        ...
        <div class="md:flex md:items-center md:justify-between mb-8">
            <div class="min-w-0 flex-1">
                <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">
                    Quản lý đặt lịch Nail
                </h2>
                <p class="mt-1 text-sm text-gray-500">Xem và quản lý các yêu cầu đặt lịch làm nail từ khách hàng.</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="{{ route('nail-bookings.trash') }}"
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        @if($booking->nail && $booking->nail->primary_image_url)
                                            <img src="{{ $booking->nail->primary_image_url }}" alt="" class="h-10 w-10 rounded-lg object-cover mr-3">
                                        @endif
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">{{ $booking->nail->name ?? 'N/A' }}</div>
                                            <div class="text-xs text-gray-500">{{ number_format($booking->nail_price, 0, ',', '.') }}đ</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('nail-bookings.show', $booking->id) }}"
                                        ...
                                        {{-- Delete Button --}}
                                        <form method="POST" action="{{ route('nail-bookings.destroy', $booking->id) }}"
                                            class="inline-block"
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center bg-gray-50">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="mt-2 text-sm text-gray-500">Chưa có yêu cầu đặt lịch nail nào.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
        ...
        <form id="bulk-delete-form" method="POST" action="{{ route('nail-bookings.bulk-delete') }}" style="display:none"
