...
@section('title', 'Edit Categories Management')
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-10 bg-gray-50 h-full min-h-screen">
        ...
        <div class="md:flex md:items-center md:justify-between mb-8">
            <div class="min-w-0 flex-1">
                ...
                <p class="mt-1 text-sm text-gray-500">Cập nhật thông tin danh mục: <span class="font-medium text-gray-900">{{ $category->name }}</span></p>
            </div>
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
                        <div class="px-4 py-5 sm:p-6">
                            <h3 class="text-base font-semibold leading-6 text-gray-900 mb-4">Trạng thái hiển thị</h3>
                            ...
                            <p class="mt-2 text-xs text-gray-500">
                                Bật: Danh mục sẽ hiển thị trên website.<br>
                                Tắt: Danh mục sẽ bị ẩn đi.
                            </p>
                            ...
                            <div class="space-y-2">
                                <p class="text-xs text-gray-500 flex justify-between">
                                    <span>Ngày tạo:</span>
                                    <span class="font-medium text-gray-700">{{ $category->created_at->format('d/m/Y H:i') }}</span>
                                </p>
                                <p class="text-xs text-gray-500 flex justify-between">
                                    <span>Cập nhật cuối:</span>
                                    <span class="font-medium text-gray-700">{{ $category->updated_at->format('d/m/Y H:i') }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
