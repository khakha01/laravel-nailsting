...
@section('title', 'Create Categories Management')
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-10 bg-gray-50 h-full min-h-screen">
        ...
        <div class="md:flex md:items-center md:justify-between mb-8">
            <div class="min-w-0 flex-1">
                ...
                <p class="mt-1 text-sm text-gray-500">Tạo mới phân loại sản phẩm hoặc bài viết.</p>
            </div>
                        ...
                        <div class="px-4 py-6 sm:p-8">
                            <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-2">
                                        <textarea id="description" name="description" rows="4"
                                            ...
                                            placeholder="Nhập mô tả ngắn về danh mục này...">{{ old('description') }}</textarea>
                                        @error('description')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Số nhỏ hiển thị trước (Mặc định: 0).</p>
                                </div>
                            </div>
                        </div>
                    </div>
