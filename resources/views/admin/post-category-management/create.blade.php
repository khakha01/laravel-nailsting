...
@section('content')
    ...
    <div class="min-h-screen bg-[#f8fafc] pb-12">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-slate-900">Thêm Danh Mục Bài Viết</h2>
                            <p class="text-xs text-slate-500 font-medium uppercase tracking-wider">Post Category Management
                            </p>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form id="main-category-form" action="{{ route('post-categories.store') }}" method="POST">
                @csrf
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div class="lg:col-span-4 space-y-6">
                        ...
                        <div
                            ...
                            <h3 class="font-bold mb-2">Sẵn sàng lưu?</h3>
                            <button type="submit" form="main-category-form"
