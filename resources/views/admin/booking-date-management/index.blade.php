    ...
    <div class="px-4 sm:px-6 lg:px-8 py-10 bg-gray-50 h-full min-h-screen">
        ...
        <div class="md:flex md:items-center md:justify-between mb-8">
            ...
            <div class="mt-4 flex md:ml-4 md:mt-0 gap-2">
                <button type="submit" form="bulk-delete-form" id="bulkDeleteBtn" disabled
                    class="inline-flex items-center rounded-md bg-[#e80707] px-4 py-2 text-sm font-semibold text-white opacity-75 cursor-not-allowed hover:bg-red-700 transition-all">
                    Xóa đã chọn
                </button>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                    ...
                    <div class="md:col-span-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="date" value="{{ request('date') }}"
                                class="w-full pl-10 rounded-lg border-gray-200 bg-gray-50 text-gray-700
                               focus:bg-white focus:border-pink-500 focus:ring-pink-500 sm:text-sm h-10 transition-colors">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-4">
                        ...
                        <div class="relative">
                            ...
                            <select name="is_open"
                                class="w-full pl-10 rounded-lg border-gray-200 bg-gray-50 text-gray-700
                               focus:bg-white focus:border-pink-500 focus:ring-pink-500 sm:text-sm h-10 transition-colors appearance-none">
                    ...
                    <div class="md:col-span-4 flex items-center gap-2">
                        <button type="submit"
                            class="inline-flex justify-center items-center gap-2 rounded-lg bg-[#000] px-4 h-10
                           text-sm font-medium text-white shadow-sm hover:bg-[#0c8fe1] focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 transition-all">
        ...
        <form id="bulk-delete-form"
            method="POST"
            action="{{ route('booking-dates.bulk-delete') }}"
                        ...
                        @forelse ($dates as $date)
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <input type="checkbox" name="booking_date_ids[]"  value="{{ $date->id }}" form="bulk-delete-form"
                                        class="h-4 w-4 text-pink-600 border-gray-300 rounded focus:ring-pink-500 row-checkbox">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            class="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-lg bg-pink-50 text-pink-600 font-bold border border-pink-100">
                                            {{ $date->date->format('d') }}
                                        </div>
                                        <div class="ml-4">
                                    ...
                                    @else
                                        <div class="flex flex-wrap gap-2">
                                            @foreach ($date->timeSlots as $slot)
                                                <span
                                                    class="inline-flex items-center px-2.5 py-0.5 rounded text-sm font-medium border {{ $slot->is_open ? 'bg-gray-50 text-gray-700 border-gray-200' : 'bg-red-50 text-red-400 border-red-100 line-through decoration-red-400' }}">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function toggleDeleteBtn() {
        ...
        deleteBtn.classList.toggle('opacity-75', checked === 0);
