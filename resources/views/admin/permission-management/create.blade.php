    ...
    <div class="px-4 sm:px-6 lg:px-8 py-10 bg-gray-50 h-full min-h-screen">
        ...
        <div class="md:flex md:items-center md:justify-between mb-8">
            <div class="min-w-0 flex-1">
                ...
                <p class="mt-1 text-sm text-gray-500">Tạo quyền hạn mới cho hệ thống.</p>
            </div>
                            ...
                            <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        @enderror
                                        <p class="mt-1 text-xs text-gray-500">Tên nhóm để phân loại quyền.</p>
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        @error('code')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                        <p class="mt-1 text-xs text-gray-500">Code duy nhất để xác định quyền (sử dụng dấu gạch ngang).</p>
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-2">
                                        <textarea id="description" name="description" rows="4"
                                            ...
                                            placeholder="Nhập mô tả chi tiết về quyền này...">{{ old('description') }}</textarea>
                                        @error('description')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
