...
@section('content')
    ...
    <div class="min-h-screen bg-[#f8fafc] pb-12">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-slate-900">Thêm Quyền Mới</h2>
                            <p class="text-xs text-slate-500 font-medium uppercase tracking-wider">Permission Management
                                System</p>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form id="main-permission-form" action="{{ route('permissions.store') }}" method="POST">
                @csrf
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="group" id="group" value="{{ old('group') }}" required autofocus
                                    ...
                                    @enderror
                                    <p class="mt-1 text-xs text-slate-500">Tên nhóm để phân loại quyền.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    @error('code')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-xs text-slate-500">Code duy nhất để xác định quyền (sử dụng dấu gạch
                                        ngang).</p>
                                </div>
                    ...
                    <div class="lg:col-span-4 space-y-6">
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                            ...
                            <div class="p-4 rounded-xl border border-amber-100 bg-amber-50">
                                <h4 class="text-xs font-bold text-amber-800 uppercase mb-2">Hướng dẫn</h4>
                                <ul class="text-xs text-amber-700 space-y-1 list-disc pl-4 italic">
                                    <li>Code phải là duy nhất trong hệ thống.</li>
                                    <li>Sử dụng dấu gạch ngang trong code.</li>
                                    <li>Tên và mô tả bằng tiếng Việt.</li>
                                </ul>
                            </div>
                        </div>
