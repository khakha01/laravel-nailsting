                        ...
                        <div class="px-4 py-6 sm:p-8">
                            ...
                            <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Đường dẫn thân thiện SEO (Ví dụ: cham-soc-da-mat).
                                    </p>
                                </div>
                            ...
                            <div id="pricesContainer" class="space-y-4">
                                ...
                                @php
                                    $oldPrices = old('prices', [
                                        ['price_type' => 'fixed', 'price' => '', 'price_min' => '', 'price_max' => ''],
                                    ]);
                                @endphp
                                ...
                                @foreach ($oldPrices as $index => $price)
                                    ...
                                    <div
                                        class="price-item bg-gray-50 p-4 rounded-lg border border-gray-200 relative group animate-fade-in-down">
                                        {{-- Nút xóa --}}
                                        <button type="button"
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            {{-- Cột 1: Chọn loại giá --}}
                                            <div>
                                                <label class="block text-xs font-medium text-gray-500 uppercase mb-1">Loại
                                                    giá</label>
                                                <select name="prices[{{ $index }}][price_type]"
                                                    ...
                                                    <option value="fixed" {{ $type == 'fixed' ? 'selected' : '' }}>Giá cố
                                                        định</option>
                                                    <option value="per_nail" {{ $type == 'per_nail' ? 'selected' : '' }}>
                                                        Từng móng</option>
                                                    <option value="range" {{ $type == 'range' ? 'selected' : '' }}>Khoảng
                                                        giá</option>
                                                </select>
                                            </div>
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="text" oninput="formatCurrency(this)"
                                                            name="prices[{{ $index }}][price_min]" step="1000"
                                                    ...
                                                    <div>
                                                        <label
                                                            ...
                                                            nhất</label>
                                                        <input type="text" oninput="formatCurrency(this)"
                                                            name="prices[{{ $index }}][price_max]" step="1000"
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
                        <div class="px-4 py-5 sm:p-6">
                            ...
                            {{-- Display Order --}}
                            <div>
                                <label for="display_order" class="block text-sm font-medium leading-6 text-gray-900">Thứ
                                    tự hiển thị</label>
                                <div class="mt-2">
