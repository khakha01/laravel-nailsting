@if(Auth::guard('admin')->user()->hasPermission('product-view'))
    <li>
        <button onclick="toggleSubmenu('submenu-products', 'arrow-products')"
            ...
            <svg id="arrow-products" class="w-4 h-4 transition-transform duration-300" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
