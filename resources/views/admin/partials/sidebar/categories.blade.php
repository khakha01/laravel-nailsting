@if(Auth::guard('admin')->user()->hasPermission('category-view'))
    <li>
        <button onclick="toggleSubmenu('submenu-categories', 'arrow-categories')"
            ...
            <svg id="arrow-categories" class="w-4 h-4 transition-transform duration-300" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
