...
@section('content')
    ...
    <div class="min-h-screen bg-[#f8fafc] pb-12">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-slate-900">Cập nhật Nail</h2>
                            <p class="text-xs text-slate-500 font-medium uppercase tracking-wider">ID: #{{ $nail->id }} -
                                Nail Management System</p>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form id="main-nail-form" action="{{ route('nails.update', $nail->id) }}" method="POST">
                @csrf
                @method('PUT')
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="4" placeholder="Nhập mô tả chi tiết về nail..."
                                        class="w-full rounded-xl border border-gray-300 bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all px-4 py-3 text-sm text-slate-700">{{ old('description', $nail->description) }}</textarea>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="p-4 rounded-xl border border-blue-100 bg-blue-50">
                                    <h4 class="text-xs font-bold text-blue-800 uppercase mb-2">Thông tin</h4>
                                    <div class="text-xs text-blue-700 space-y-1">
                                        <p class="flex justify-between">
                                            <span>Ngày tạo:</span>
                                            <span class="font-semibold">{{ $nail->created_at->format('d/m/Y H:i') }}</span>
                                        </p>
                                        <p class="flex justify-between">
                                            <span>Cập nhật:</span>
                                            <span class="font-semibold">{{ $nail->updated_at->format('d/m/Y H:i') }}</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
