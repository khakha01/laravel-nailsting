...
{{-- Usage: @include('admin.components.media-manager-modal') --}}
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-5xl h-[80vh] flex flex-col">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse border-t">
                    ...
                    <button type="button" id="mm-delete-selected-btn" onclick="deleteSelectedMedia()" class="hidden w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
...
{{-- Required for MediaManager internal logic (though we override confirm) --}}
<div id="hidden-inputs-wrapper" class="hidden"></div>
<div id="selected-images-container" class="hidden"></div>
<div id="no-selection-text" class="hidden"></div>
