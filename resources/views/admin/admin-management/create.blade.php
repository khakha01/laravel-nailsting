...
@section('content')
    ...
    <div class="min-h-screen bg-[#f8fafc] pb-12">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-slate-900">Thêm Admin Mới</h2>
                            <p class="text-xs text-slate-500 font-medium uppercase tracking-wider">Admin Management System
                            </p>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form id="main-admin-form" action="{{ route('admins.store') }}" method="POST">
                @csrf
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-4">
                                        <div id="avatar-preview-container"
                                            ...
                                            @if(old('media_id'))
                                                <img src="{{ get_media_url(old('media_id')) }}"
                                        ...
                                        <button type="button" onclick="removeAvatar()" id="remove-avatar-btn"
                                            class="px-4 py-2 text-sm font-bold text-red-600 bg-red-50 border border-red-200 rounded-lg hover:bg-red-100 transition-all {{ old('media_id') ? '' : 'hidden' }}">
                                            Xóa
                                        </button>
                                    </div>
                                    @error('media_id')
