                        ...
                        @if($permissions->count() > 0)
                            <div class="space-y-4">
                                ...
                                @foreach($groupedPermissions as $group => $groupPerms)
                                    <div>
                                        <h4 class="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-2">{{ $group }}</h4>
                                        <div class="flex flex-wrap gap-2">
                                            @foreach($groupPerms as $permission)
                                                <span class="inline-flex items-center rounded-full bg-blue-100 px-3 py-1.5 text-sm font-medium text-blue-700">
                ...
                @if($admin->avatar)
                    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
                        <div class="px-4 py-5 sm:p-6">
                            ...
                            <img src="{{ $admin->avatar }}" alt="{{ $admin->name }}" class="w-full rounded-lg">
                        </div>
                    </div>
                @endif
                ...
                <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <button onclick="confirmDelete({{ $admin->id }})" class="flex w-full justify-center items-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-700 transition-all">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
