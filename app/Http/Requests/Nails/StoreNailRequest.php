...
class StoreNailRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'max:255', 'unique:nails,slug'],
            'description' => ['nullable', 'string', 'max:5000'],
            'status' => ['required', 'string', 'in:active,inactive'],
            'images' => ['nullable', 'array'],
            'images.*.image' => ['required', 'image', 'mimes:jpeg,jpg,png,gif,webp', 'max:5120'], // 5MB max
    ...
    public function messages(): array
    {
        return [
            ...
            'images.*.image.required' => 'Hình ảnh là bắt buộc',
